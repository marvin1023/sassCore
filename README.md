...
sassCore 很久都不更新了，如有需要请迁移至更精简的[sandal](https://github.com/marvin1023/sandal)
...
#### css3
建议使用 postCSS 的 autoprefix 来解决前缀。负责css3属性前缀的文件。参考了[bourbon](http://bourbon.io/)，然后进行一系列的扩展及优化，以使解析出来的代码更加合理。
